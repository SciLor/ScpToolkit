...
namespace ScpProfiler
{
    ...
    public partial class ButtonMappingEntryControl : UserControl
    {
        ...
        private void CurrentCommandTargetOnCurrentChanged(object sender, EventArgs eventArgs)
        {
            switch (ButtonProfile.MappingTarget.CommandType)
            {
                case CommandType.GamepadButton:
                    ButtonProfile.MappingTarget.CommandTarget = (DsButton) CurrentCommandTargetView.CurrentItem;
                    break;
        ...
        private static readonly IEnumerable<ButtonsEnum> AvailableGamepadButtons = Enum.GetValues(typeof(ButtonsEnum)).Cast<ButtonsEnum>();
        ...
        {
            get => (DsButtonProfile) GetValue(ButtonProfileProperty);
