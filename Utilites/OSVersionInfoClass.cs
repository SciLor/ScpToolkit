    ...
    public static class OsVersionInfo
    {
        ...
        public static SoftwareArchitecture ProgramBits
        {
            get
            {
                ...
                //try
                //{
                //    SYSTEM_INFO l_Syste_Info = new SYSTEM_INFO();
                //    GetSystemInfo(ref l_Syste_Info);

                //    switch (l_Syste_Info.uProcessorInfo.wProcessorArchitecture)
                //    {
        ...
        public static ProcessorArchitecture ProcessorBits
        {
            get
            {
                ...
                try
                {
                    var l_Syste_Info = new SYSTEM_INFO();
                    GetNativeSystemInfo(ref l_Syste_Info);
