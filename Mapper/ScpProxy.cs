...
using ButtonMapper.XInput;
using log4net;
using ScpControl.ControllerContract.Core;
using ScpControl.ControllerContract.Enums;
using ScpControl.ScpCore;

namespace ButtonMapper
{
    public sealed partial class ScpProxy
    {
        ...
        /// </summary>
        public bool IsNativeFeedAvailable => _rootHub.IsNativeFeedAvailable();
        ...
        private void OnFeedPacketReceived(IScpHidReport data)
        {
            ...
            NativeFeedReceived?.Invoke(this, data);
        }

        private void OnRootHubDisconnected(object sender, EventArgs args)
        {
            RootHubDisconnected?.Invoke(sender, args);
        }
