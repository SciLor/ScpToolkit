...
namespace Config
{
    public class GlobalConfiguration : ICloneable
    {
        ...
        public static GlobalConfiguration Instance => LazyInstance.Value;

        #endregion

        #region Const vars

        public static int IdleTimeoutMultiplier => 60000;

        public static int LatencyMultiplier => 16;
        ...
        /// </summary>
        public static string AppDirectory => WorkingDirectory;
        ...
        public bool IsLightBarDisabled => Settings.Default.Ds4LightBarBrightness == 0;

        public bool IdleDisconnect => Settings.Default.IdleTimeout != 0;
