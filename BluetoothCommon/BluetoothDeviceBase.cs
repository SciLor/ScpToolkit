...
{
    public class BluetoothDevice : IEquatable<BluetoothDevice>, IComparable<BluetoothDevice>
    {
        #region IComparable<ScpBthConnection> Members

        public virtual int CompareTo(BluetoothDevice other)
        {
        ...
        {
            return $"{DeviceAddress.AsFriendlyName()}";
        }
        ...
        #region Ctors
        public BluetoothDevice(BthHandle hciHandle)
        {
            HciHandle = hciHandle;
        ...
        public BthHandle HciHandle { get; }

        public PhysicalAddress DeviceAddress { get; }
        ...
        public virtual bool Equals(BluetoothDevice other)
        {
