...
{
    internal partial class BthDongle
    {
        ...
        private void L2CapWorker(object o)
        {
            ...
            Log.DebugFormat("-- Bluetooth  : L2CAP_Worker_Thread Starting (IN: {0:X2}, OUT: {1:X2})", BulkPipeIdIn, BulkPipeIdOut);
        ...
        private void ParseBufferDs4(BluetoothGamepadBase connection, byte[] buffer, int transfered)
        {
                ...
                if (Enum.IsDefined(typeof (L2CAP.Code), buffer[8]))
                {
                    ...
                    switch (Event)
                    {
                        ...
                        case L2CAP.Code.L2CAP_Disconnection_Request:
                            ...
                            L2_SCID = new byte[] {buffer[14], buffer[15]};
        ...
        private void ParseBufferDs3(BluetoothGamepadBase connection, L2CapDataPacket packet)
        {
            byte[] L2_DCID;
            byte[] L2_SCID;
                ...
                if (packet.IsValidSignallingCommandCode)
                {
                    ...
                    switch (Event)
                    {
                        ...
                        case L2CAP.Code.L2CAP_Configuration_Response:
                            ...
                            {
                                L2_DCID = L2CapDataPacket.UInt16ToBytes(BluetoothDeviceBase.Dcid++);
        ...
        private void HicWorker(object o)
        {
            ...
            var connection = new BluetoothDeviceBase();

            Log.DebugFormat("Bluetooth Host Controller Interface Task starting on Interrupt Input Pipe: {0:X2}", IntPipeIdIn);
                            ...
                            switch (Event)
                            {
                                ...
                                case HCI.Event.HCI_Command_Complete_EV:
                                    ...
                                    if (command == HCI.Command.HCI_Read_Local_Version_Info && buffer[5] == 0)
                                    {
                                        ...
                                        HciVersion = $"{buffer[6]}.{buffer[8] << 8 | buffer[7]:X4}";
                                        LmpVersion = $"{buffer[9]}.{buffer[13] << 8 | buffer[12]:X4}";
                                ...
                                case HCI.Event.HCI_Connection_Request_EV:
                                    ...
                                    HCI_Accept_Connection_Request(bdAddr, 0x00);
                                ...
                                case HCI.Event.HCI_Connection_Complete_EV:
                                    ...
                                    if (buffer[2] == 0x00)
                                    {
                                        ...
                                        HCI_Remote_Name_Request(bdAddr);
                                    }
                                    else
                                    {
                                        Log.WarnFormat(
                                ...
                                case HCI.Event.HCI_Remote_Name_Request_Complete_EV:
                                    ...
                                    bd =
                                        $"{buffer[8]:X2}:{buffer[7]:X2}:{buffer[6]:X2}:{buffer[5]:X2}:{buffer[4]:X2}:{buffer[3]:X2}";
                                    ...
                                    {
                                        HCI_Reject_Connection_Request(bdAddr, 0x0F);
                                    }
                                    break;
                                ...
                                case HCI.Event.HCI_Link_Key_Request_EV:
                                    ...
                                    HCI_Link_Key_Request_Reply(bdAddr);
                                    HCI_Set_Connection_Encryption(connection.HciHandle);
                                    break;
                                ...
                                case HCI.Event.HCI_PIN_Code_Request_EV:
                                    ...
                                    HCI_PIN_Code_Request_Negative_Reply(bdAddr);
                                    break;
